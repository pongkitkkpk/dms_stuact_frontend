...
import { StudentRoutes } from "routes.js"; // Import StudentRoutes
...
function Student() {
  ...
  const getRoutes = () => { // Remove StudentRoutes argument
    return StudentRoutes.map((prop, key) => { // Use StudentRoutes directly
  ...
  return (
    <>
      <Sidebar
        ...
        routes={StudentRoutes} // Use StudentRoutes here
