...
function SD_studentgetmoney({ id_project, currentStepProject }) {
  ...
  const calculateRemainingBudget = () => {
    ...
    const receivedBudgetall = parseFloat(
      numberstudent_receive.toString().replace(/,/g, "")
    );
                          ...
                          <tr style={{ backgroundColor: "white" }}>
                            ...
                            <td style={{ verticalAlign: "middle" }}>
                              <Form.Control
                                ...
                                value={numberstudent_receive.toLocaleString(
                                  "en-US"
                                )}
                                onChange={(event) => {
                                  let value = Number(
                                  ...
                                  const netbudget = parseFloat(
                                    net_budget.toString().replace(/,/g, "")
                                  );
                                  if (value > netbudget) {
                                    value = netbudget;
                                  }
                          ...
                          <tr style={{ backgroundColor: "white" }}>
                            <td style={{ verticalAlign: "middle" }}>
                              ...
                              >
                                ...
                                {Array.isArray(stuactpersonList) &&
                                  stuactpersonList.map((person, index) => (
                                    <option
                                      key={index}
                                      value={person.name_student}
                                    >
                                      {person.name_student}
                                    </option>
                                  ))}
